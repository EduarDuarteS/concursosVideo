...
do
    ...
    mysql -h localhost -uproyecto1 -ph3lpUsJ3sus\!20 -e "UPDATE proyecto1.Videos SET isConverted=1 WHERE originalPath='$UNPROCESSED$FILE';UPDATE proyecto1.Videos SET convertedPath='$CONVERTED$TMP.mp4' WHERE originalPath='$UNPROCESSED$FILE';UPDATE proyecto1.Videos SET originalPath='$UPLOAD$FILE' WHERE originalPath='$UNPROCESSED$FILE'"
    EMAIL=$(mysql -h localhost -uproyecto1 -ph3lpUsJ3sus\!20 -s -N -e "SELECT email FROM proyecto1.Videos WHERE convertedPath='$CONVERTED$TMP.mp4'");
